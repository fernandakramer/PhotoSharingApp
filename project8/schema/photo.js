...
/*
 * Photo can have likes and we stored them in the Photo object itself using
 * this Schema:
 */
var likeSchema = new mongoose.Schema({
    user_id: String, // the ID of the user who liked it
});
...
var photoSchema = new mongoose.Schema({
    ...
    likes: [String],  // change this into an array of strings [String]
    //number_of_likes: String // remove this
});
